 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30.2, -40.7, -3.9 }
...
#define LCD_BED_TRAMMING
  ...
  // -30.2, -40.7, -3.9
  #define BED_TRAMMING_INSET_LFRB { 20, 20, 31, 42 } // (mm) Left, Front, Right, Back insets
...
#define PREHEAT_2_LABEL        "PLA4Planes"
